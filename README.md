# Envoy Gateway service for Wodby

Use Envoy Gateway as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Envoy Gateway service in the Wodby catalog.

- [Envoy Gateway service in the Wodby catalog](https://wodby.com/services/envoy-gateway)
...
4. Reference `envoy-gateway` from your stack manifest.
